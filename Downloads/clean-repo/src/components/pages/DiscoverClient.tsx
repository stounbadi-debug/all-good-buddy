...
import { Brain, Sparkles, Filter, Zap, Search } from "lucide-react"
        ...
        <div className="container mx-auto px-4 sm:px-6 pt-8 max-w-7xl">
          <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
            ...
            <TabsContent value="discover" className="space-y-8">
                ...
                <div className="py-20 particle-bg">
                  <div className="text-center animate-scale-in">
                    ...
                    <p className="text-2xl text-muted-foreground mb-12 max-w-3xl mx-auto font-light leading-relaxed font-inter">
                      Find your perfect movie with AI-powered recommendations and intelligent search.
                    </p>
              ...
              {(currentView !== "featured" || !featuredMovie) && displayMovies.length > 0 && (
            ...
            <TabsContent value="search" className="space-y-8">
              <EnhancedSearchInterface 
                onMoviesFound={handleAIMoviesFound}
                isLoading={isLoading}
              />
              
              {/* Show results if any */}
              {displayMovies.length > 0 && currentView === "ai" && (
                <div className="animate-fade-in">
                  <MovieGrid 
                    movies={displayMovies}
                    isLoading={false}
